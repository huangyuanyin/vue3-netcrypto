  ...
  const option = {
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return '<div>' + params[0].name + '<br>' + params[0].marker + '用例数' + ':' + '<span style="color: #00B83F;">' + params[0].value + '</span>' + '<br>' + params[0].marker + '模块数：' + '<span style="color: #00B83F;">' + params[0].data.children.length + '</div>';
      }
    },
    grid: {
      left: 90,
