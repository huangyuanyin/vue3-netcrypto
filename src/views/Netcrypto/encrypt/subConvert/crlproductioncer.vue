<template>
  <div class="numberCer">
    <h5>生成CRL文件数量</h5>
    <el-form :model="numberCRLForm" :rules="numberCRLFormRules" ref="numberCRLFormRef" label-width="130px" size="small">
  ...
  <div class="informationCer">
    <h5>证书信息设置</h5>
    <el-form :model="informationCRLForm" :rules="informationCRLFormRules" ref="informationCRLFormRef" label-width="130px" size="small">
      ...
      <el-form :model="informationCRLForm.extstrlist" ref="extstrlistFormRef" v-if="addExtstrlist == '1'" label-width="130px" size="small">
      ...
      <el-form-item label="">
        <el-button size="small" type="primary" @click="generateCer()">生成CRL</el-button>
      </el-form-item>
    </el-form>
  </div>
